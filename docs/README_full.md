...
[![CI](https://github.com/Constantine-S-AN/AH-Diff-Dashboard/actions/workflows/ci-pages.yml/badge.svg)](https://github.com/Constantine-S-AN/AH-Diff-Dashboard/actions/workflows/ci-pages.yml)
[![Pages](https://img.shields.io/website?url=https%3A%2F%2Fconstantine-s-an.github.io%2FAH-Diff-Dashboard%2F&up_message=online&down_message=offline&label=pages)](https://constantine-s-an.github.io/AH-Diff-Dashboard/)
[![License](https://img.shields.io/github/license/Constantine-S-AN/AH-Diff-Dashboard)](LICENSE)
[![Python](https://img.shields.io/badge/python-3.11%2B-3776AB?logo=python&logoColor=white)](https://www.python.org/)
[![Ruff](https://img.shields.io/badge/lint-ruff-46a758?logo=ruff&logoColor=white)](https://docs.astral.sh/ruff/)
...
> 离线可用：无需联网，直接打开 `docs/index.html` 即可查看预生成成果。
...
无需联网打开：
- 直接双击或浏览器打开 `docs/index.html`
- 页面内可跳转到 `docs/reports/cost_sensitivity_demo.html`
...
- 本地缓存：`data/cache/*.parquet`（自动读写）

离线演示模式：
- `scripts/build_offline_demo.py` 优先从 `data/cache` 构建 `docs/index.html` 与 `docs/reports/*`
- 若缓存不足，会回退到 `tests/fixtures/research_regression` 的 pair 元数据生成离线示例
- Streamlit 在 `OFFLINE=1` 下只读缓存，不发起网络请求
